...
class DataTransformationConfig:
    def __init__(self):
        ...
        self.ids_to_labels_aws_path: str = os.path.join(
...
class ModelEvalConfig:
    def __init__(self):
        ...
        self.aws_model_path: str = os.getcwd()
        self.aws_local_path: str = AWS_MODEL_NAME
...
class ModelPusherConfig:
    def __init__(self):
        ...
        self.model_name: str = AWS_MODEL_NAME
...
class ModelPredictorConfig:
    def __init__(self):
        ...
        self.best_model_from_aws_path: str = os.path.join(BEST_MODEL_DIR)
